...
public class PolymorphismService {
	 ...
	 * 	 (다형성 - 업캐스팅 적용)		 
	 * 
	 * * 매개 변수 : 매서드 호출 시 전달된 값을 저장하는 변수
	 */
	
	/* * 참조변수 instanceof 클래스명
	 * 
	 * - 참조 변수가 참조하는 객체가 "클래스명"으로 만들어진 객체가 맞을 경우 true,아님 false
	 * 
	...
	public void test4() {
		...
		// 오버라이딩된 메서드로 연결(오버라이딩된 메서드가 우선권을 갖는다)
		
		for(Object obj:arr) { // 향상된for문
		 ...
		 *   실행을 멈추고 해당 시점에 존재하는 변수/필드 값을 확인하는 모드
		 */
	}
	...
	public void test6(Object obj) {
		 ...
		 *    참조하는 객체가 변환하려는 타입이 아니거나 상속관계도 아니면
