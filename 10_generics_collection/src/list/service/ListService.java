...
public class ListService {
	 ...
	 * - 기본적으로 타입 제한은 없지만 개발의 편의성을 위해
	 * 	 한 가지 타입으로 제한 -> 제네릭스 이용
	 */
	...
	public void test2() {
		 ...
		 * - 없으면 -1 반환
		 */
		System.out.println("초밥 인덱스 : " + menuList.indexOf("초밥"));
...
//		try {
//			Thread.sleep(1000); // 현재 Thread를 1000ms 동안 멈춤
