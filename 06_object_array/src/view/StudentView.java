...
public class StudentView {
	 ...
	 * <pre>
	 * 학번, 이름, 성별을 입력 받아
	 * StudentDTO 객체로 만들어서 StudentService.addStudent() 메서드에 전달
	 ...
	 * 이름을 입력 받아
	 *    반환형         클래스명.메서드명(매개 변수)
	 *  StudentDTO Student = Service.selectName(String name) 호출
	 *  
	 *  - 학생 정보 반환 받아서 출력
	 *  단, 반환 받은 학생이 없을 경우(null)
	...
	private void updateIndex() {
		...
		// 정상 index인 경우
		// HTML, CSS, JS, Java 순서로 점수 입력 : 100 20 30 40
	 ...
	 * 
	 * <pre>
	 * - 인덱스 번호를 입력 받아 해당 인덱스에학생이 있는지 확인
	 * 1)index 범위 초과 : "인덱스 범위가 올바르지 않습니다
	 * 2) 참조하는 학생이 없을 경우 :
	 * 		"해당 인덱스에 학생이 존재하지 않습니다" 출력
	 * 
	...
	private void deleteStudent() {
		...
		System.out.println(studentName + "삭제 되었습니다");
