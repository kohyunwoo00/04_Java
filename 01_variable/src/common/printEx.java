...
public class printEx {
	public static void main(String[] args){
		...
		/* System.out == 지정된 출력용 화면(이클립스 큰솔)
		 * 
		 * 1) System.out.prin(출력내용);
		 * - 출력 내용을 콘솔에 출력
		 * - 출력 완료 후 줄이 바뀌지 않음
		 * 
		 ...
		 * - 문자열 템플릿 중간에 "%"로 시작하는 패턴을 입력하여 원하는 변수/값 대입 가능
		 * 
		 * [패턴 종류]
		 ...
		 * ex) %4d, 3 대입 -> ㅁㅁㅁ3 (ㅁ -> 빈칸 표시)
		 * - 음의 정수 : 정수 크기만큼 칸 확보 + 왼쪽 정렬
		 * ex) -%4d, 3 대입 -> 3ㅁㅁㅁ
		 * 
		 * - 소수점 : 소수점 아래 몇째 자리까지 표시할지 지정(지정된 자리 아래에서 반올림 표시)
		 * ex) %.1f, 3.15 대입 -> 3.2
		 */
	  ...
	  System.out.println("[printf() 확인하기]");
		...
		String name = "신짱구"; // 참조형(값 지정X, 값의 위치(주소) 저장)
