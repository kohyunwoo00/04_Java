...
public class VariableEx3 {
	public static void main(String[] args) {
		...
		System.out.println((double)a3 / (double)b3);  // (double)int / (double)int = double  == 2.5 
		
		System.out.println((double)a3 / b3);  
		// (double)int      <- 강제 형변환
		// -> double / int  <- 자동 형변환 적용 -> double / double = double == 2.5
		...
		System.out.println("A 뒤에 10번째 문자 : " + (char)('A' + 10));  // K가 나오게하는 방법
