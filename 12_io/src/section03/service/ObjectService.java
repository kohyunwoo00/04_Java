...
public class ObjectService {
	...
	public void outputMember() {
		...
		try {
			// 출력할 Member 객체 생성
			Member member = new Member("member1122", "1q2w3e4r", "짱구");
	...
	public void outputMemberList() {
		...
		try {
			...
			memberList.add(new Member("member02", "pass02", "유리"));
			memberList.add(new Member("member03", "pass03", "맹구"));
			memberList.add(new Member("member04", "pass04", "훈이"));
