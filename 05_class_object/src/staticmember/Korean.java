...
public class Korean {
	 ...
	 * - 생성 시기 : 객체 생성 시
	 * - 소멸 시기 : 객체 소멸 시
	 * (어떤 변수도 객체를 참조하지 않을 경우 Heap 메모리 영역의 GC(Garbage Collection)
	 */
	private String name; // 이름
	private String id;  // 주민등록번호

	/* 인스턴스 초기화 블럭 : 인스턴스 변수 초기화 목적 (객체가 만들어질때마다 실행)*/
	{
