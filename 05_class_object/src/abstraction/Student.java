...
// class : 객체의 멤버(필드, 메서드)를 정의한 문서(== 설계
...
//private 접근 제한자 - 외부 직접 접근을 제한(캡슐화 원칙)
  ...
  /* 기본 생성자
   * - 매개 변수가 없는 생성자
   * - 클래스내에 생성자가 1개도 없으면 컴파일러가 자동으로 추가해준다
   * -> public 클래스명(){}
   * 
   *  
   *  */
  public Student() {
  	...
  	// 참조형 : null(참조하는 객체가 없다, 저장된 구조가 없다)
   ...
   * 	 매개변수(순터, 타입, 개수)를 다르게하여 같은 이름의 메서드라도 구분할 수있게 된다
   * 
   */
   ...
   * }
   */
  // 직접 접근이 제한된 필드에 간접 접근하는 방법을제공하는 메서드
  // getter/setter
