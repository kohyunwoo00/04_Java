...
public class Book {
	...
	public Book(long bookNumber, String title, String author, int pice) {
		super();
	...
	public String toString() {
		return "Book [bookNumber=" + bookNumber + ", title=" + title + ", author=" + author + ", pice=" + price + "]";
	}
	...
	public boolean equals(Object obj) {
		...
		if(obj == null) return false; // 비교대상이 없는 경우 -> 무조건 false
